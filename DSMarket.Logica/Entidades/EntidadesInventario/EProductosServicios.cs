...
{
    public class EProductosServicios
    {
		...
		public System.Nullable<bool> TieneImagen0 {get;set;}
		...
		public System.Nullable<decimal> IdTipoGarantia {get;set;}

		public string TipoTiempoGarantia {get;set;}

		public System.Nullable<int> TiempoGarantia {get;set;}
		...
		public System.Nullable<decimal> GananciaAproximadaTotal {get;set;}
	}
}
