...
{
    public class ProcesarInformacionCotizacionDetalle
    {
        ...
        public ProcesarInformacionCotizacionDetalle(
        ...
        /// <summary>
        /// Procesar la informacion del detalle de la cotización
        /// </summary>
        public void ProcesarInformacion() {

            DSMarket.Logica.Entidades.EntidadesServicio.ECotizacionDetalle Procesar = new Entidades.EntidadesServicio.ECotizacionDetalle();
            ...
            var MAN = Objdata.ProcesarCotizacionDetalle(Procesar, Accion);
